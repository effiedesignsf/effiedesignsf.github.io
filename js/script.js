...
$(function(){
	...
	$("[data-template-target]").each(function(){
		console.log("bork")
		$(this).html(
			$($(this).data("template-target")).html()
		);
	})
	...
	// progress circle code reference: https://codepen.io/jacobhummel/pen/kyugL

	$(function() {
	$('#progress').circliful();
});

    // Map funtion starts here
    var map;
    function initMap(){
